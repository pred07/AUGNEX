# Windows Hardening & GPO Security

## 1. Orientation

### What this module covers
This module covers **Windows Hardening & GPO Security**, a critical concept in the **Builder (Security Engineering)** path. You will explore the theoretical foundations and practical applications of this topic.

### Learning Objectives
By the end of this module, you will:
*   Understand the core principles of Windows Hardening & GPO Security
...
### Introduction to Windows Hardening & GPO Security
...
### Lab Scenario
**Objective:** Apply your knowledge of Windows Hardening & GPO Security to a realistic problem.
...
### Knowledge Check
1.  What is the primary security benefit of implementing Windows Hardening & GPO Security?
...
1.  **Define** Windows Hardening & GPO Security and its importance.
