...
import { getAllUsers, adminAddCoins } from '../lib/firestoreService';
import { useAuth } from '../context/AuthContext';
import { useNavigate } from 'react-router-dom';
import { Shield, Coins, Search, User, AlertTriangle } from 'lucide-react';
                        ...
                        {filteredUsers.map(user => (
                            <tr key={user.id} className="hover:bg-white/5 transition-colors">
                                ...
                                <td className="p-4 text-right">
                                    ...
                                    {user.role === 'admin' && user.id !== user.uid && ( // Prevent self-demotion
                                        <Button
                                            variant="ghost"
                                            size="sm"
